    ...
    public class Menu
    {
        ...
        public void Start()
        {
            while (true)
            {
                ...
                string getConsole = GetConsoleString();

                if (getConsole == "q") break;

                try
                {
                    DefineBehavior(getConsole);
                } catch (Exception ex)
                {
                    err = ex.Message;
                }
        ...
        private void AddCar()
        {
            ...
            Console.Write("Масса машины (кг)"); // Масса
            int mass = GetConsoleInt();
            Console.Write("Объём бака (л)"); // Объем бака
        ...
        private void AddCarriage()
        {
            ...
            Console.WriteLine("q - перестать добавлять коней");
